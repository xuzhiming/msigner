...
export const BITCOIN_RPC_HOST = process.env.VITE_BITCOIN_RPC_HOST || 'http://localhost';
...
export const BITCOIN_RPC_TIMEOUT = Number(process.env.VITE_BITCOIN_RPC_TIMEOUT ?? 120000);
